package com.formerlunchbox.web.limiter.config;
...
public class CustomedRedisAutoConfiguration {
  ...
  // */
  // @Bean
  // public RedisConnectionFactory connectionFactory(JedisPoolConfig
  // jedisPoolConfig)
  // {
  ...
  RedisRateLimiter redisRateLimiter(RedisRateLimitProperties redisRateLimitProperties,
    ...
    return new RedisRateLimiter(stringRedisTemplate, redisRateLimitProperties);
  }
